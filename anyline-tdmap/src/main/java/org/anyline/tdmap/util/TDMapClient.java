...
public class TDMapClient extends AbstractMapClient implements MapClient {
	...
	public String create(String name, int loctype, String lng, String lat, String address, Map<String, Object> extras){
		String url = TDMapConfig.DEFAULT_YUNTU_HOST + "/datamanage/data/create"; 
	...
	public long delete(List<String> ids){
		...
		String url = TDMapConfig.DEFAULT_YUNTU_HOST + "/datamanage/data/delete"; 
		String txt = HttpUtil.post(url, "UTF-8", params).getText(); 
	...
	public long update(String id, String name, int loctype, String lng, String lat, String address, Map<String, Object> extras){
		long cnt = 0;
		String url = TDMapConfig.DEFAULT_YUNTU_HOST + "/datamanage/data/update"; 
		Map<String, Object> params = new HashMap<>(); 
		params.put("key", config.KEY); 
		params.put("tableId", config.TABLE); 
		params.put("loctype", loctype+""); 
	...
	public String createTable(String name){
		String tableId = null; 
		String url = TDMapConfig.DEFAULT_YUNTU_HOST + "/datamanage/table/create"; 
		Map<String, Object> params = new HashMap<>(); 
		params.put("key", config.KEY); 
	...
	public DataSet<DataRow> local(String keywords, String city, String filter, String sortrule, int limit, int page){
		...
		String url = TDMapConfig.DEFAULT_YUNTU_HOST + "/datasearch/local"; 
		Map<String, Object> params = new HashMap<>(); 
		params.put("key", config.KEY); 
		params.put("tableId", config.TABLE); 
	...
	public DataSet<DataRow> around(String center, int radius, String keywords, Map<String, String> filters, String sortrule, int limit, int page){
		DataSet<DataRow> set = null; 
		String url = TDMapConfig.DEFAULT_YUNTU_HOST + "/datasearch/around"; 
		Map<String, Object> params = new HashMap<>(); 
		params.put("key", config.KEY); 
		params.put("tableId", config.TABLE); 
	 ...
	 * TDMapClient.getInstance(TABLE_TENANT).list("tenant_id:1","shop_id:1", 10, 1);
	 * @param filter 查询条件 
	...
	public DataSet<DataRow> list(String filter, String sortrule, int limit, int page){
		DataSet<DataRow> set = null; 
		String url = TDMapConfig.DEFAULT_YUNTU_HOST + "/datamanage/data/list"; 
		Map<String, Object> params = new HashMap<>(); 
		params.put("key", config.KEY); 
		params.put("tableId", config.TABLE); 
		params.put("filter", filter); 
	...
	public DataRow info(String id){
		DataRow row = null; 
		String url = TDMapConfig.DEFAULT_YUNTU_HOST + "/datasearch/id"; 
		Map<String, Object> params = new HashMap<>(); 
		params.put("key", config.KEY); 
		params.put("tableId", config.TABLE); 
		params.put("_id", id); 
	...
	public DataSet<DataRow> statByProvince(String keywords, String country, String filter){
		DataSet<DataRow> set = null; 
		String url = TDMapConfig.DEFAULT_YUNTU_HOST + "/datasearch/statistics/province"; 
		Map<String, Object> params = new HashMap<>(); 
		params.put("key", config.KEY); 
		params.put("tableId", config.TABLE); 
		params.put("filter", filter); 
	...
	public DataSet<DataRow> statByCity(String keywords, String province, String filter){
		DataSet<DataRow> set = null; 
		String url = TDMapConfig.DEFAULT_YUNTU_HOST + "/datasearch/statistics/city"; 
		Map<String, Object> params = new HashMap<>(); 
		params.put("key", config.KEY); 
		params.put("tableId", config.TABLE); 
		params.put("filter", filter); 
	...
	public DataSet<DataRow> poi(String city, String keywords){
		...
		DataRow row = get(TDMapConfig.DEFAULT_HOST, url,params);
