...
public class TDMapConfig extends AnylineConfig{
	...
	public static TDMapConfig getInstance(String key){
		...
		return (TDMapConfig)instances.get(key); 
	} 
	/** 
	 * 加载配置文件 
	 */ 
	...
	public static TDMapConfig register(String instance, DataRow row) {
		TDMapConfig config = parse(TDMapConfig.class, instance, row, instances, compatibles);
		return config;
	}
	public static TDMapConfig register(String instance, String key, String secret, String table) {
	...
	public static TDMapConfig register(String key, String secret, String table) {
		return register(DEFAULT_INSTANCE_KEY, key, secret, table);
	}
	public static TDMapConfig register(String key, String secret) {
